...
public final class DataManagerImpl implements DataManager {
    ...
    @Override
    public Map<String,Boolean> getPhotoToRuleMapping(final RestogramPhoto... data) {
        ...
        Map<String, Boolean> photoToRule = getPhotoToRuleMapping(instaIds);
        if (photoToRule == null)
    ...
    @Override
    public Map<String,Boolean> getPhotoToRuleMapping(final String... ids) {
    ...
    @Override
    public PhotosResult fetchPhotosFromCache(final String venueId, final String token) {
    ...
    @Override
    public Map<String,RestogramVenue> fetchVenuesFromCache(final String[] ids) {
    ...
    @Override
    public boolean cacheVenue(final RestogramVenue venue) {
        if (venue == null)
            return false;
    ...
    @Override
    public boolean isValidCursor(String token) {
        try
        {
    ...
    @Override
    public boolean updatePhotoReference(final String photoId, final boolean isFav) {
    ...
    @Override
    public boolean changePhotoYummiesCount(final String photoId, final int delta) {
        int retries = 2;
        while (true)
        {
    ...
    @Override
    public Set<String> fetchFavoritePhotoIds() {
    ...
    @Override
    public PhotosResult queryFavoritePhotos(final String token) {
    ...
    private RestogramPhotoIdsQueryResult queryFavoritePhotoIds(final String token) {
    ...
    @Override
    public boolean cachePhoto(RestogramPhoto photo) {
    ...
    @Override
    public boolean isPhotoInCache(final String photoId) {
    ...
    private PhotosResult createPhotosResultFromQueryResult(final QueryResult queryResult) {
    ...
    private RestogramPhoto[] entitiesToRestogramPhotos(final Collection<Entity> entities) {
        if (entities == null)
            return null;
    ...
    private boolean hasMoreResults(QueryResult queryResult) {
    ...
    @Override
    public boolean isPhotoPending(final String photoId) {
        return getMemcacheService().get(photoId) !=  null;
    }

    @Override
    public RestogramPhoto getPendingPhoto(final String photoId) {
        return (RestogramPhoto)getMemcacheService().get(photoId);
    }

    @Override
    public void addPendingPhotos(final Map<String, RestogramPhoto> pendingPhotos) {
        getMemcacheService().putAll(pendingPhotos);
    }

    @Override
    public void removePendingPhotos(final Collection<String> photoIds) {
